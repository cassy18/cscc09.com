...
Students are permitted and encouraged to use AI tools to assist with writing code in this course. The following models are approved for use:

- GitHub Copilot (GPT-5.4)
- Claude Sonnet 4.6

Use of AI tools is subject to the following requirements:

1. **Prompt logging.** All prompts used to generate code must be recorded in a `prompts.txt` file included in your repository. Prompts must be preserved as-is and in full — you must not delete, edit, or omit any prompts used during development. The teaching team reserves the right to inspect prompt logs and AI tool usage history to investigate potential academic misconduct.
2. **Original instruction.** You must formulate prompts in your own words. Copying the assignment handout verbatim into an AI tool is not permitted. You are expected to personally direct the AI tool based on your own understanding of the problem.
3. **Understanding.** You are responsible for all code you submit, whether written by you or generated by an AI tool. If challenged, you must be able to explain and reproduce your work.

The following are considered **unacceptable uses of AI** and will be treated as academic misconduct:

- Using the assignment handout verbatim as an input prompt to an AI tool.
- Submitting prompts that are highly similar to those of another student. Shared or copied prompts constitute plagiarism.
- Using unapproved models, including but not limited to Claude Opus 4.6. Only the models listed above are permitted.
