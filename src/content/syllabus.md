...
1. **Session logging.** If you start an AI session, at the end of the session, you must export the entire conversation between you and the AI, and put it in your repository.
